                            ...
                            <div class="col-11">
                                ...
                                <div class="form-group mt-3">
                                    ...
                                    <div class="d-flex gap-3">
                                        ...
                                        ">
                                            <input type="radio" id="popularNew" name="newType" value="Popular New"  @if ($post->new_type == "Popular New") checked @endif>
                                            <label class="text-muted mt-2
                                            " for="popular">Popular New</label>
                                        </div>
                                        <div class="d-flex align-items-center gap-2">
                                            <input type="radio" id="trendNew" name="newType" value="Trend New" @if ($post->new_type == "Trend New") checked @endif>
                                            <label class="text-muted mt-2
                                            " for="trendNew">Trend New</label>
                                        </div>
                                        <div class="d-flex align-items-center gap-2">
                                            <input type="radio" id="titleNew" name="newType" value="Title New"  @if ($post->new_type == "Title New") checked @endif>
                                            <label class="text-muted mt-2
